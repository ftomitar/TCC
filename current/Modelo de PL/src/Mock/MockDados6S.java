...
public class MockDados6S {
    ...
    public void gerarMaterias(){
        ...
        materias.put("AlgoritmosJK", new Materia("AlgoritmosJK", 2, "A"));
        materias.put("EstruturaDeDadosJK", new Materia("EstruturaDeDadosJK", 2, "A"));
        
        materias.put("RedesJK", new Materia("RedesJK", 1, "A"));
        materias.put("LabRedesJK", new Materia("LabRedesJK", 2, "A"));
        
        materias.put("OrientacaoObjetosJK", new Materia("OrientacaoObjetosJK", 1, "A"));
        materias.put("EngenhariaSoftwareJK", new Materia("EngenhariaDeSoftwareJK", 2, "A"));
        
        materias.put("BancoDeDadosJK", new Materia("BancoDeDadosJK", 2, "A"));
        
        materias.put("ESTJK", new Materia("ESTJK", 2, "A"));
        materias.put("ESPJK", new Materia("ESPJK", 1, "A"));
        
        
        
        
        materias.put("RedesIIJK", new Materia("RedesIIJK", 1, "B"));
        materias.put("LabRedesIIJK", new Materia("LabRedesIIJK", 2, "B"));
        
        materias.put("BancoDeDadosIIJK", new Materia("BancoDeDadosIIJK", 2, "B"));
        materias.put("LabBancoDeDadosIIJK", new Materia("LabBancoDeDadosIIJK", 2, "B"));
        
        materias.put("LPIJK", new Materia("LPIJK", 2, "B"));
        
        materias.put("LPIIJK", new Materia("LPIIJK", 2, "B"));
        
        materias.put("GrafosJK", new Materia("GrafosJK", 2, "B"));
        
        materias.put("SistemasDistribuidosJK", new Materia("SistemasDistribuidosJK", 2, "B"));
        
        
        materias.put("AlgoritmosIIJK", new Materia("AlgoritmosIIJK", 2, "A"));
        materias.put("EstruturaDeDadosIIJK", new Materia("EstruturaDeDadosIIJK", 2, "A"));
        
        materias.put("RedesABJK", new Materia("RedesABJK", 1, "A"));
        materias.put("LabRedesABJK", new Materia("LabRedesABJK", 2, "A"));
        
        materias.put("OrientacaoObjetosIIJK", new Materia("OrientacaoObjetosIIJK", 1, "A"));
        materias.put("EngenhariaSoftwareIIJK", new Materia("EngenhariaDeSoftwareIIJK", 2, "A"));
        
        materias.put("BancoDeDadosABJK", new Materia("BancoDeDadosABJK", 2, "A"));
        
        materias.put("ESTABJK", new Materia("ESTJK", 2, "A"));
        materias.put("ESPABJK", new Materia("ESPJK", 1, "A"));
        
        
        
        
        materias.put("RedesIIABJK", new Materia("RedesIIABJK", 1, "B"));
        materias.put("LabRedesIIABJK", new Materia("LabRedesIIABJK", 2, "B"));
        
        materias.put("BancoDeDadosIIABJK", new Materia("BancoDeDadosIIABJK", 2, "B"));
        materias.put("LabBancoDeDadosIIABJK", new Materia("LabBancoDeDadosIIABJK", 2, "B"));
        
        materias.put("LPIABJK", new Materia("LPIABJK", 2, "B"));
        
        materias.put("LPIIABJK", new Materia("LPIIABJK", 2, "B"));
        
        materias.put("GrafosABJK", new Materia("GrafosABJK", 2, "B"));
        
        materias.put("SistemasDistribuidosABJK", new Materia("SistemasDistribuidosABJK", 2, "B"));
