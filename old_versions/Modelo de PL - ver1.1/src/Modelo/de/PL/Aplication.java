...
public class Aplication {
    ...
    public void gerarHorarios(){
        ...
        horarios.add(new Horario("Primeira"));
        horarios.add(new Horario("Segunda"));
        horarios.add(new Horario("Terceira"));
        horarios.add(new Horario("Quarta"));
        horarios.add(new Horario("Quinta"));
        horarios.add(new Horario("Sexta"));
        horarios.add(new Horario("Setima"));
        horarios.add(new Horario("Oitava"));
        horarios.add(new Horario("Nona"));
        horarios.add(new Horario("Decima"));
        horarios.add(new Horario("DecimaPri"));
        horarios.add(new Horario("DecimaSeg"));
        horarios.add(new Horario("DecimaTer"));
        horarios.add(new Horario("DecimaQua"));
        horarios.add(new Horario("DecimaQui"));
