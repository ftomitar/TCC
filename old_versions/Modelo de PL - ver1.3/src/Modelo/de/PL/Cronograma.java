...
public class Cronograma {
    ...
    public String concat(String nomeAula, String nomeProf, String nomeMat){
        String resp = "";
        
        resp = nomeAula + separador + nomeProf + separador + nomeMat;
        ...
        for(Professor prof: professor){
            ...
            for(Materia mat: materia){
                ...
                for(Horario hora: horario){
                    ...
                    equacao = equacao + concat(nomeAula, nomeProf, nomeMat)+ "+";
            ...
            for(Professor prof: professores){
                if (prof.horarioLivre(periodo)){
                    ...
                    for(Materia mat: materias){
                        nomeMat = mat.getNome();
                        eq = eq + concat(nomeAula, nomeProf, nomeMat) + "+";
                    }
                }
            }
            if (eq != ""){
        ...
        for(Professor prof: professor){
            ...
            for(Materia mat: materia){
                ...
                for(Horario hora: horario){
                    ...
                    variavel = concat(nomeAula, nomeProf, nomeMat );
                    if(type == "integer"){
